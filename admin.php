            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td><button class="edit-button" onclick="showEditForm(<?php echo $row['prod_code']; ?>)">Edit</button></td>
                    </tr>
                    <?php
                }
            } else {
                echo "<tr><td colspan='6'>No products found! Check out your products data.</td></tr>";
            }
